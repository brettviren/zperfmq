...
typedef struct _zperfmq_t zperfmq_t;
typedef struct _int_t int_t;
typedef struct _zhash_t zhash_t;
// CLASS: zperf
...
// Destroy the zperfmq.
void
    zperfmq_destroy (zperfmq_t **self_p);

// Create a server, return status code.
int_t *
    zperfmq_server (zperfmq_t *self, const char *server_name);

// Create a client, return status code.
int_t *
    zperfmq_client (zperfmq_t *self, const char *client_name);
...
const char *
    zperfmq_publish (zperfmq_t *self, const char *nickname);

// Return a hash of zyre peer IDs and nick names.
zhash_t *
    zperfmq_peers (zperfmq_t *self);

// Return information about a zyre peer.
zhash_t *
    zperfmq_peer_info (zperfmq_t *self, const char *peerid);

// Self test of this class.
void
    zperfmq_test (bool verbose);
